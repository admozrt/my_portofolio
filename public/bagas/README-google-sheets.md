# Setup Backend Google Sheets (RSVP & Ucapan) — Bagas & Nadira

Undangan ini menyimpan **RSVP** dan **Ucapan (Constellation Wall)** ke Google Sheets lewat
...
`src/pages/wedding/WeddingPageBagasNadira.tsx`.
...
6. Buka `src/pages/wedding/WeddingPageBagasNadira.tsx`, isi:
   ```ts
...
> Catatan: posisi titik di Constellation Wall di-generate ulang **di client-side** setiap load
> dari daftar ucapan — tidak perlu disimpan di Sheets.
