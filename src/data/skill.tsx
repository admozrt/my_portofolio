...
const ExpoIcon: React.FC<{ className?: string }> = ({ className = "" }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
    ...
    height="1em"
  >
    <path d="M0 21.793L10.61 2.55C11.11.903 11.607.6 12 .6c.393 0 .89.304 1.39 1.95L24 21.793c.5.848.304 1.44 0 1.753-.305.412-.806.454-1.391.454H1.39C.806 24 .305 23.958 0 23.546c-.304-.313-.5-.905 0-1.753zM12 7.56L4.833 20.88h14.334L12 7.56z" />
  </svg>
);
...
export const skills: Skill[] = [
  ...
  { icon: faReact, name: 'React Native', color: 'text-blue-400', level: 78, category: 'Frontend' },
  ...
  { icon: faGithub, name: 'Github', color: 'text-gray-300', level: 88, category: 'Tools' },
  { icon: faNpm, name: 'NPM', color: 'text-red-600', level: 85, category: 'Tools' },
  {
    icon: <ExpoIcon className="text-lg" />,
    name: 'Expo',
    color: 'text-gray-200',
    level: 75,
    category: 'Tools',
